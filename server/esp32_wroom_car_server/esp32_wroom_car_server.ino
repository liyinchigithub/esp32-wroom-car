...
// 定义电机驱动板的引脚，ESP32的引脚
const int motorLeftIn1 = 23;   // 左电机输入1 IN1
const int motorLeftIn2 = 22;   // 左电机输入2 IN2
const int motorRightIn1 = 19;  // 右电机输入1 IN3
const int motorRightIn2 = 18;  // 右电机输入2 IN4
const int motorLeftEn = 21;    // 左电机使能 ENA
const int motorRightEn = 5;    // 右电机使能 ENB
...
<title>遥控小车V2.0 Remote Car Control</title>
<style>
<style>
  body, html {
    height: 100%;
...
void setup() {
  ...
  Serial.println("ESP32 is set as a WiFi Access Point with SSID: " + String(ssid));
